...
%\usepackage{citation-style-langauge} %% does not work research later
...
% % \usepackage{xunicode} \usepackage{xltxtra} \setmainfont{Minion Pro}
...
\address{3901 Rainbow Blvd HLSIC 3095}{Kansas City, KS 66160, USA} % optional, remove the line if not wanted
% \mobile{Mobile: 240-421-2460} % optional, remove the line if not wanted
\phone[mobile]{+1~(240)~428-8246} % optional, remove the line if not wanted
% %\fax{fax (optional)} % optional, remove the line if not wanted
\email{malaykbasu@gmail.com} % optional, remove the line if not wanted

\homepage{www.malaybasu.com} % optional, remove the line if not wanted
\social[linkedin]{malaybasu} % optional, remove the line if not wanted
\social[github]{malaybasu} % optional, remove the line if not wanted
...
\renewcommand*\hintfont{\fontsize{9}{10}\selectfont}
...
\cventry{2022--Present}{Adjuct faculty}{Computational Biology Program}{Kansas University}{Lawrence, KS, USA}{Academic research, hiring, mentoring, teaching.}
...
\cventry{2013--2022}{Director}{Genifx Genome Informatics Facility}{University of Alabama, Birmingham}{Birmingham, AL, USA}{Genifx genome analysis facility at UAB (\url{http://genifx.uab.edu}) is a UAB Health Science Foundation funded project to create a next-generation sequence (NGS) data storage and analysis facility at UAB. I designed, created, and now maintain CHOIR/Genifx compute cluster at Department of Pathology, UAB.}
\cventry{2012--2022}{Associate Scientist}{Comprehensive Cancer Center}{University of Alabama, Birmingham}{Birmingham, AL, USA}{Active researcher in cancer center.}
\cventry{2015--2022}{Senior Scientist}{Informatics Institute}{University of Alabama, Birmingham}{Birmingham, AL, USA}{Member, educational committee designing graduate and undergraduate curricula.}
\cventry{2014--2022}{Assistant Professor}{Department of Clinical and Diagnostic Sciences, School of Health Professions}{University of Alabama, Birmingham}{Birmingham, AL, USA}{Advisor to the master of bioinformatics program.}
\cventry{2020--2022}{Scientist}{Center for Clinical and Translational Science (CCTS)}{University of Alabama, Birmingham}{Birmingham, AL, USA}{Develop university-wide bioinformatics collaboration.}
...
\cvline{2023}{National Science Foundation (NSF), USA.}
\cvline{2021}{Israel Science Foundation (ISF), Israel.}
\cvline{2017}{National Science Foundation (NSF), USA.}
...
\subsection{Ongoing}
\cvline{2023-2028}{\emph{"The Role of ANKRD Proteins in Modulating Thrombotic Thrombocytopenic Purpura"}; NIH; Zheng (PI); role: co-investigator.}
\subsection{Completed}
\cvline{2013-2022}{\emph{Genifx service center}; Health Science Foundation; role: PI.}
\cvline{2015--2022}{\emph{RT-SQuARED-M method to study the precise role of mitochondria in the oxidative damage caused by environmental toxins}; NIH; Mitra(PI); role: co-investigator.}
\cvline{2019--2021}{\emph{Research subcontract from Yale University}; Yale University; role: co-investigator.}
...
\cvline{2023}{Poster judge, Greenwald Symposium. Kansas University Medical Center.}
\cvline{2022}{Poster judge, Greenwald Symposium. Kansas University Medical Center.}
\cvline{2021}{Moderator, Annual Translational and Transformative Informatics Symposium (ATTIS).}
\cvline{2020}{Judge, COVID-19 hackathon, University of Alabama, Birmingham.}
...
\cvline{2023-09-25}{Invited speaker, Kidney Institute, Kansas Univeristy Medical Center, Kansas, USA.}
\cvline{2023-09-08}{Invited speaker, Department of Biochemistry, Kansas Univeristy Medical Center, Kansas, USA.}
\cvline{2023-01-10}{Invited speaker, symposium on "Biology for better health". Department of Zoology, University of Calcultta, India.}
\cvline{2022-10-18}{Invited speaker, Center for Computational Biology, University of Kansas, Lawrence, KS, USA.}
...
\cvline{2023--Present}{Course master of  “CB2-101: Bioinformatics Shop Class”. A highly rated (rating score 9.5/10) hands-on 48 hours training course, open to everyone, at KUMC. Also a graduate course of 3 credit hours.  \url{http://cb2edu.org}}
\cvline{2021--2022}{Co-director and designer of a new undergraduate bioinformatics course, “Introductory bioinformatics”.}
\cvline{2018--2022}{Co-director and designer of a new bioinformatics course, “INFO 510: Programming with biological data”.}
\cvline{2014--2022}{Course master of  “CB2-101: Introduction to Scientific Computing”. A highly rated (rating score 9.5/10) hands-on 48 hours training course, open to everyone, at UAB. Also a graduate course of 3 credit hours.  \url{http://cmb.path.uab.edu/training/cb2-101.html.}}
\cvline{2015--2022}{Course master of “CB2-201: Bioinformatics and Computational Biology”. A highly rated (9.5/10) 40hr hands-on training course. Also a 3 credit graduate course. \url{http://cmb.path.uab.edu/traning/cb2-201.html.}}
...
\section{Mentoring}
\cvline{2024--Present}{Manish Kumar, Research Assistant.}
\cvline{2024--Present}{Shiwani Limbu, Rsearch Assistant.}
\cvline{2023--2024}{Dincer Killic, Research Assistant.}
...
\cvline{2023}{Moreno A, Basu MK, Soares M (2023) Single cell analysis of placental cells, Greenwald Symposium, Kansas University Medical Center.}
\cvline{2020-11-16}{Harada S, Iriabho E, Flannery A, Worthey E, Basu MK, Yemelyanova A, Morlote D, Mackinnon AC (2020) Pindel as a Back-Up INDEL Caller to a GATK4 Mutect2 Based In-House Developed Somatic Secondary Analysis Bioinformatics Pipeline for a Custom Clinical Cancer NGS Panel. \emph{Association for Molecular Pathology (AMP) 2020 Annual Meeting \& Expo. Vancouver, BC, Canada.}}
\cvline{2020-07-13}{Basu MK (2020) Exome sequencing identifies abnormalities in glycosylation and ANKRD36C defects as probable causes of immune-mediated thrombotic thrombocytopenic purpura (TTP). Intelligent Systems in Molecular Biology (ISMB).}
\cvline{2019-12-7}{Massicano F, Staley E, Halkidis K, Kocher N, Williams LA, Marques MB, Guillory B, Cao W, Basu MK, Zheng XL (2019) Exome sequencing identifies glycosylation defects as a probable cause of immune thrombotic thrombocytopenic purpura, American Society of Hematology annual conference, Dec 7-10, 2019, Orlando, FL.} 
